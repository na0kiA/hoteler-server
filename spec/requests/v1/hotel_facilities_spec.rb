  ...
  describe "PATCH /v1/hotels/:hotel_id/hotel_facilities - v1/hotel_facilities #update" do
    context "ホテルの設備を更新する場合" do
      ...
      it "wifiを利用可能にできること" do
        ...
        expect(symbolized_body(response)[:hotel][:hotelFacilities][:wifiEnabled]).to be(true)
      end
      ...
      it "全ての設備を利用可能にできること" do
        ...
        expect(symbolized_body(response)[:hotel][:hotelFacilities][:breakfastEnabled]).to be(true)
      end
    end
  end
end
