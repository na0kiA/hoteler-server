  ...
  describe "PATCH /v1/hotels/:hotel_id/hotel_facilities - v1/hotel_facilities #update" do
    context 'ホテルの設備を更新する場合' do
      ...
      it '全ての設備を利用可能にできること' do
        patch v1_hotel_hotel_facilities_path(hotel.id), params: {hotel_facilities: {wifi_enabled: true, parking_enabled: true, triple_rooms_enabled: true, secret_payment_enabled: true, credit_card_enabled: true, phone_reservation_enabled: true, net_reservation_enabled: true, cooking_enabled: true, breakfast_enabled: true}}, headers: auth_tokens
