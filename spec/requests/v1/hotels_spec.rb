  ...
  describe "GET /v1/hotels - v1/hotels#index" do
    ...
    context "ホテルが満室の場合" do
      it "ホテル一覧のfullがtrueなこと" do
        # params = { hotel: { name: "神戸北野", content: "最高峰のラグジュアリーホテルをお届けします", full: true, company: "株式会社ホテルサービス", phone_number: "030-1111-1111", prefecture: "東京", city: "渋谷区", street_address: "2丁目11-1", postal_code: "332-2344", user: client_user }, notification: { message: "新しいソファーを設置しました。" } }
        params = { hotel: {full: true, user_id: client_user.id}}
