...
RSpec.describe HotelSerializer, type: :serializer do
  describe HotelSerializer do
    ...
    let_it_be(:hotel) { create(:completed_profile_hotel, :with_a_day_and_rest_rates, user_id: user.id) }
