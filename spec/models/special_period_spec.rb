...
RSpec.describe SpecialPeriod, type: :model do
  describe 'SpecialPeriod#check_that_today_is_a_special_period' do
    ...
    context '今日が特別期間の場合' do
      ...
      it 'trueが返ること' do
        expect(described_class.check_that_today_is_a_special_period?(hotel:)).to eq(true)
      end
    end
    ...
    context '今日が特別期間じゃない場合' do
      ...
      it 'falseが返ること' do
        expect(described_class.check_that_today_is_a_special_period?(hotel:)).to eq(false)
      end
    end
  ...
  describe 'SpecialPeriod#check_that_today_is_a_last_day_of_special_periods' do
    ...
    context '今日が特別期間最終日の場合' do
      ...
      it 'trueが返ること' do
        expect(described_class.check_that_today_is_a_last_day_of_special_periods?(hotel:)).to eq(true)
      end
    end
