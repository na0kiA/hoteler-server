...
RSpec.describe HotelImage, type: :model do
  describe "models/hotel_image.rb #save_keys" do
    ...
    context "keyが9個ある場合" do
      ...
      it "9個保存できること" do
        ...
        expect { images.save_keys }.to change(HotelImage, :count).by(9)
      end
    end
    ...
    context "keyが10個ある場合" do
      ...
      it "保存に失敗すること" do
        ...
        images = described_class.new(hotel_images)
        expect { images.save_keys }.not_to change(HotelImage, :count)
        expect(images.save_keys).to be_nil
      end
    end
  end
end
